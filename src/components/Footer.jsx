...
const socials = [
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="social-icon" aria-hidden="true">
      ...
      <div className="footer-inner">
        <div className="footer-grid">
          ...
          <div className="footer-brand-col">
            <div className="footer-logo">ABTalks</div>
            <p className="footer-tagline">
              India's coding community for college students. Build in public. Get noticed.
            </p>
            <a
          ...
          <div className="footer-links-col">
            ...
            <ul className="footer-link-list">
              <li><a href="/dashboard">60-Day Challenge</a></li>
              <li><a href="#">Vibe Code Hackathon</a></li>
              <li><a href="#">31 Days AI Cohort</a></li>
              <li><a href="#">Claude Challenge</a></li>
            </ul>
          </div>

          {/* Links col */}
          <div className="footer-links-col">
            <div className="footer-col-title">Student</div>
            <ul className="footer-link-list">
              <li><a href="/dashboard">Dashboard</a></li>
              <li><a href="/day/12">Today's Challenge</a></li>
          ...
          <div className="footer-social-col">
            ...
            <div className="footer-email-row">
              <span className="footer-email-label">📧 Enquiries:</span>
              <a href="mailto:team@abtalks.in" className="footer-email-link">
                team@abtalks.in
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-copy">© 2025 ABTalks. Built in public. 🇮🇳</div>
